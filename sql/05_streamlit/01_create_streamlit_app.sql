...
CREATE OR REPLACE STAGE SFE_STREAMLIT_STAGE
    ...
    COMMENT = 'DEMO: MerchMasters - Stage for Streamlit app files | Author: SE Community | Expires: 2026-04-10';
...
CREATE OR REPLACE STREAMLIT SFE_THE_LEADERBOARD
    ...
    COMMENT = 'DEMO: MerchMasters - The Leaderboard Dashboard | Author: SE Community | Expires: 2026-04-10';
