...
CREATE SCHEMA IF NOT EXISTS SFE_MERCH_RAW
    COMMENT = 'DEMO: MerchMasters - Raw synthetic data landing zone | Author: SE Community | Expires: 2026-01-31';

-- Staging layer for cleaned/typed data
CREATE SCHEMA IF NOT EXISTS SFE_MERCH_STAGING
    COMMENT = 'DEMO: MerchMasters - Cleaned and validated data | Author: SE Community | Expires: 2026-01-31';

-- Analytics layer with star schema
CREATE SCHEMA IF NOT EXISTS SFE_MERCH_ANALYTICS
    COMMENT = 'DEMO: MerchMasters - Star schema for Cortex Analyst | Author: SE Community | Expires: 2026-01-31';
